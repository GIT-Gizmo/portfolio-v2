        ...
        <div id="#about" className="py-20 flex flex-col overflow-hidden">
            ...
            >
                <article className="flex flex-col gap-5">
                    ...
                    <h2 className="text-lg sm:text-2xl font-bold text-purple">How I got here</h2>
                    ...
                    <h2 className="text-lg sm:text-2xl font-bold text-purple">Where I&apos;m looking to go next</h2>
